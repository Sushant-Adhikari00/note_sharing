...
const CreatePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!allowedTypes.includes(file.type)) return toast.error("Only PDF, PNG, PPT, PPTX files are allowed");
            ...
            <div className="card-body">
              ...
              <form onSubmit={handleSubmit} encType="multipart/form-data">
                ...
                <div className="form-control mb-4">
                  ...
                  <input type="file" accept=".pdf,.png,.ppt,.pptx" className="file-input file-input-bordered"
